...
class StoryDetailPageWithPl extends StatefulWidget {
  final int currentStoryIndex;
  final List<StoryModel?> storyList;
  const StoryDetailPageWithPl(
      {super.key, required this.currentStoryIndex, required this.storyList});

  @override
  State<StoryDetailPageWithPl> createState() => _StoryDetailPageWithPlState();
}

class _StoryDetailPageWithPlState extends State<StoryDetailPageWithPl> {
          ...
          itemBuilder: (context, pageIndex, storyIndex) {
            ...
            return Stack(
              children: [
                ...
                Positioned.fill(
                  child: Image.network(story['storyPhotoUrl']),
                ),
                _isStoryPaused
                    ? SizedBox()
                    : Padding(
