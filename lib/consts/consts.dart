...
class Consts {
  static const String initialEmail = 'test@gmail.com';
  ...
  // static const Color primaryAppColor = Colors.yellow;
  // static const Color secondaryAppColor = Colors.greenAccent;
  // static const Color tertiaryAppColor = Colors.deepPurpleAccent;
}
